...
export const AGENT_DOCS = {
  ...
  fees: `vaults.cash takes ${Number(process.env.NEXT_PUBLIC_FEE_BPS ?? 60) / 100}% of the deposit (and of the converted output on withdraw), included in the returned calls. Minimum deposit or add: $${MIN_DEPOSIT_USD} (plan requests below it are rejected).`,
  markets:
